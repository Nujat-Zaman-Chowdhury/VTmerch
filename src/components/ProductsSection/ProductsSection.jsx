...
const ProductsSection = () => {
    ...
    return (
        <div className="md:ml-10 lg:ml-[148px] p-2 md:p-0 mt-10 md:mt-0 md:py-[101px]">
            <h1 data-aos="zoom-in" className="uppercase font-montserrat text-2xl md:text-[40px] lg:text-[70px] font-semibold text-[#060606] tracking-[0.5px] leading-[120%] mb-[48px]">Buy 1 get 1 Free <br /> 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full p-2 lg:p-0">
                {
                    products.map((product,index)=>(
                        <div data-aos={index % 2 === 0 ? 'fade-up' : 'fade-down'} key={product.productName} className="rounded-[12px] pb-6 px-4 pt-4 shadow-md flex flex-col font-inter w-full  lg:w-96 hover:shadow-lg cursor-pointer">
